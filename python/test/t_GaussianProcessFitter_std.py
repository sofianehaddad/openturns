...
def bugfix_optim_no_feasible():
    ...
    optimal_cov_parameter = [1.05e+07, 1500, 1500, 50.7, 5.119, 4.807,\
                             5.238, 2.445, 2.302, 5.058, 7.188, 4.915]
    ...
    ott.assert_almost_equal(
        result.getCovarianceModel().getParameter(), optimal_cov_parameter, 1e-3, 1e-4
    )
    ott.assert_almost_equal(squared_epsilon, [1.932e-05, 49.89, 1.861], 1e-4, 1e-3)
