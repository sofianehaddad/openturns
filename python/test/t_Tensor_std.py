...
try:
    ...
    print "values = %.6f" % tensor1[0, 0, 0], "  %.6f" % tensor1[1, 0, 0], "  %.6f" % tensor1[0, 1, 0], "  %.6f" % tensor1[1, 1, 0], "  %.6f" % tensor1[0, 0, 1], "  %.6f" % tensor1[1, 0, 1], "  %.6f" % tensor1[0, 1, 1], "  %.6f" % tensor1[1, 1, 1], "  %.6f" % tensor1[0, 0, 2], "  %.6f" % tensor1[1, 0, 2], "  %.6f" % tensor1[0, 1, 2], "  %.6f" % tensor1[1, 1, 2]
    ...
    print "tensor1's nbRows = ", tensor1.getNbRows(),
    ...
    import sys
    print "t_Tensor_std.py", sys.exc_type, sys.exc_value
