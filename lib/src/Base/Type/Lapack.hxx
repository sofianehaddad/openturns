...
void DGEQRF_F77(int *m, int *n, double *a, int *lda, double *tau, double *work, int *lwork, int *info);

/** Function dorgqr is used to generate a real matrix Q with orthogonal columns */
#define DORGQR_F77 F77_FUNC(dorgqr,DORGQR)
void DORGQR_F77(int *m, int *n, int *k, double *a, int *lda, double *tau, double *work, int *lwork, int *info);
