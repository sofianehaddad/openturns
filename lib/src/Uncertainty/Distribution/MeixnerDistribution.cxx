...
void MeixnerDistribution::update()
{
  ...
  const CenteredFiniteDifferenceGradient gradientB(epsilon, fB.getEvaluationImplementation());
  fB.setGradientImplementation(gradientB.clone());
  ...
  const CenteredFiniteDifferenceGradient gradientCD(epsilon, fCD.getEvaluationImplementation());
  fCD.setGradientImplementation(gradientCD.clone());
