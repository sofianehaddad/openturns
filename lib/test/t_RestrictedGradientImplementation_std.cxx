...
int main(int argc, char *argv[])
{
  ...
  try
  {
    ...
    RestrictedGradientImplementation restriction(*analytical.getGradientImplementation(), restrictionIndices, referencePoint);
    ...
    point[1] =  4.0;
    point[2] = -4.0;
    fullprint << "reference value=" << analytical.getGradientImplementation()->gradient(point) << std::endl;
  }
  catch (TestFailed & ex)
  {
